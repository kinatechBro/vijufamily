...
const Gallery: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.title =
        "Viju Industries (Nigeria) Limited - Premium Beverages & Dairy Products";
    };
  }, []);
  ...
  const visibleGalleryCategories = galleryCategories.filter(
    (category) => !excludedCategoryIds.includes(category.id),
  );

  const allImages = visibleGalleryCategories.flatMap((category) =>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-12 font-light leading-relaxed">
              Explore our journey through memorable moments, achievements, and
